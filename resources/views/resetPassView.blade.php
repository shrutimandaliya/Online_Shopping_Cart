                                ...
                                <div class="account-box">
                                    ...
                                    <div class="account-content">
                                       {{--  <div class="text-center m-b-20">
                                        ...
                                        <form method="post" class="form-horizontal" action="{{ url('updatePass/') }}" id="form">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group row m-b-20">
                                                <div class="col-12">
                                                    ...
                                                    parsley-trigger="change" required placeholder="john@deo.com">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row m-b-20">
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control" type="password" name="password" parsley-trigger="change" required >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row m-b-20">
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control" type="password" name="confirmPass" parsley-trigger="change" required >
                                                </div>
                                            </div>
