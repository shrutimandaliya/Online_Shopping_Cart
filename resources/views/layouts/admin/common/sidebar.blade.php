                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('categoryDetails') }}">
                                    <i class="dripicons-blog"></i><span>  Category </span>
                                </a>
                             ...
                             <li>
                                <a href="{{ url('productDetails') }}">
                                    <i class="fi-layout"></i><span>  Product </span>
                                </a>
                            </li>

                             <li>
                                <a href="{{ url('colorDetails') }}">
                           ...
                           {{--  <li>
                                <a href="{{ url('brand') }}"><i class="fa fa-list-alt "></i> <span> Brand </span></a>
                            </li>
                            <li>
                                <a href="{{ url('color') }}"><i class="fa fa-list-alt "></i> <span> Color </span></a>
                            </li>
                            <li>
                                <a href="{{ url('product') }}"><i class="fa fa-list-alt "></i> <span> Product </span></a>
                            </li>
